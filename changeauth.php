...
<div class="am-form am-tab-panel am-fade am-in am-active" id="tab1" style="min-height: 300px;">
  ...
  <fieldset>
    ...
    <div class="am-form-group">
      <input type="text" id="host" minlength="3" placeholder="旧域名" class="am-form-field" required/>
    </div>
    <div class="am-form-group">
      <input type="text" id="zzqq" minlength="3" placeholder="绑定的QQ" class="am-form-field" required/>
    </div>
     <div class="am-form-group">
      <input type="text" id="newhost" minlength="3" placeholder="新域名" class="am-form-field" required/>
    </div>
  <div class="am-form-group">
      <input type="text" id="skey" minlength="3" placeholder="站长密钥" class="am-form-field" required/>
    </div>
<div class="am-form-group">
 ...
 <img src="./code.php?r=<?=time()?>" style="display: inline;" id="piccode" height="35"onclick="this.src='./code.php?r='+Math.random();" title="点击更换验证码">
    ...
    <div class="am-form-group">
        <button class="am-btn am-btn-secondary" id="changeauthbyskey" type="submit" style="width: 100%">更换授权</button>
    </div>
