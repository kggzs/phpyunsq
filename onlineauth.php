...
<div class="am-form am-tab-panel am-fade am-in am-active" id="tab1" style="min-height: 300px;">
  ...
  <fieldset>
    ...
    <div class="am-form-group">
      <input type="text" id="zzqq" minlength="3" placeholder="绑定QQ" class="am-form-field" required/>
    </div>
     <div class="am-form-group">
      <input type="text" id="skey" minlength="3" placeholder="自定义密钥" class="am-form-field" required/>
    </div>
  <div class="am-form-group">
      <input type="text" id="km" minlength="3" placeholder="授权卡密" class="am-form-field" required/>
    </div>
<div class="am-form-group">
 ...
 <img src="./code.php?r=<?=time()?>" style="display: inline;" id="piccode" height="35"onclick="this.src='./code.php?r='+Math.random();" title="点击更换验证码">
    ...
    <div class="am-form-group">
        <button class="am-btn am-btn-secondary" id="onlineauth" type="submit" style="width: 100%">立即授权</button>
       </div>
